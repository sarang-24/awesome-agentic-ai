...
A curated list of awesome frameworks, libraries, tools, tutorials, and resources for building autonomous, multi-agent, and collaborative Agentic AI systems.
...
Libraries and software development kits for building single-agent systems.
...
* **[MetaGPT](https://github.com/geekan/MetaGPT)** - Multi-agent framework that takes a one-line requirement as input and outputs user stories/specs/code.
...
High-quality tutorials and learning resources to master Agentic AI.

* **[DeepLearning.AI: Multi-Agent Systems](https://www.deeplearning.ai/short-courses/multi-agent-systems-with-crewai/)** - Practical course on building multi-agent systems with CrewAI.
* **[LangChain Academy](https://academy.langchain.com/)** - Official interactive guides and courses for building advanced agents.
